...
const ui = {
  title: { fontSize: 32, fontWeight: 700, color: '#000', textAlign: 'center', mb: 3 },
  button: {
    bgcolor: '#000',
    color: '#fff',
    py: 1.25,
...
export default function ApplyCandidateComponent() {
  ...
  // Garantir cancelamento ao desmontar o componente
  useEffect(() => {
    return () => {
  ...
  const validate = () => {
    ...
    if (form.resumeFile && !allowed.includes(form.resumeFile.type)) return 'CV deve ser PDF/DOC/DOCX.';
    if (form.resumeFile && form.resumeFile.size > 10 * 1024 * 1024) return 'CV excede 10MB.';
    return null;
  };
  ...
  return (
    <Box component="form" onSubmit={onSubmit} noValidate>
      ...
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
        <Button type="submit" variant="contained" fullWidth disabled={loading} sx={ui.button}>
